...
<form action="allotclasses.php" method="post" style="margin-top: 100px">
    ...
    <div align="center">
        <select name="course" class="list-group-item">
            ...
            <option value="2">Be 1st Year</option>
            <option value="2">Be 2nd Year</option>
            <option value="3">Be 3rd Year</option>
            <option value="4">Be 4rth Year</option>

            <option value="2">BTech 1st Year</option>
